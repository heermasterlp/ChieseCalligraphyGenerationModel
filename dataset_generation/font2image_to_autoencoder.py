...
"""
Font to image for autoencoder model
    only contains one font in image.
"""
...
def draw_example(ch, font, image_mode, canvas_size, x_offset, y_offset, filter_hashes):
...
def font2image(font, charset, char_size, image_mode, canvas_size, x_offset, y_offset, sample_dir, lable=0, filter_by_hash=True):
    src_font = ImageFont.truetype(font, size=char_size)
    ...
    for c in charset:
        e = draw_example(c, src_font, image_mode, canvas_size, x_offset, y_offset, filter_hashes)
        if e:
...
if __name__ == '__main__':
    ...
    font2image(args.font, charset, args.char_size, args.image_mode, args.canvas_size, args.x_offset, args.y_offset,
